#!/usr/bin/python3
""" This file creates unit tests for the console.py file
Trying to test all the created functions
"""
import unittest
import os
import sys
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_create(self):
        h = ("Usage: create <class>\n        "
             "A function that helps to reate a new class instance.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("A function to help all")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help all"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_destroy(self):
        h = ("Help destroy function.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("Help update function")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help update"))
            self.assertEqual(h, output.getvalue().strip())
            
    def test_help_count(self):
        h = ("Help count function.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unit tests for the udate function"""
